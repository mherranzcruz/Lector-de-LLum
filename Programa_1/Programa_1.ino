...
void loop() {                 //Inicia el bucle del programa
  ...
  valLdr0 = map(valLdr0, 90,360 , 0, 255);   // mapejar valor de 0-1023 a 0-255
  ...
  valLdr1 = map(valLdr1, 130, 520, 0, 255);   // mapejar valor de 0-1023 a 0-255
  ...
  valLdr2 = map(valLdr2, 130, 400, 0, 255);   // mapejar valor de 0-1023 a 0-255
